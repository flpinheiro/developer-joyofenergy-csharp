...
namespace JOIEnergy
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IElectricityReadingIntervalService, ElectricityReadingIntervalService>();
            ...
            services.AddSwaggerGen(options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Description = "An ASP.NET Core Web API for managing energy industry",
                    TermsOfService = new Uri("https://example.com/terms"),
                    Contact = new OpenApiContact
                    {
                        Name = "Github Repository",
                        Url = new Uri("https://github.com/techops-recsys-lateral-hiring?q=Developer&type=&language=&sort=")
                    },
                    License = new OpenApiLicense
                    {
                        Name = "Creative Commons Legal Code",
                        Url = new Uri("https://creativecommons.org/")
                    }
                });
